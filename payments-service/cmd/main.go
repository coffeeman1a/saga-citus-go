...
import (
	...
	"github.com/coffeeman1a/saga-citus-go/payments-service/internal/server"
...
func main() {
	...
	// citus pool
	log.Debug("Starting payments-service...")
	...
	paymentRepo := repository.NewPGXRepository(pool)

	log.Debug("Starting server...")
	// start a server
	s := server.StartServer(paymentRepo)
